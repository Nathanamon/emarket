<template>
  <section class="bg-gray-50 py-16">
    <div class="max-w-2xl mx-auto text-center px-4 sm:px-6 lg:px-8">
      <h2 class="text-3xl font-bold tracking-tight text-gray-900">Products</h2>
      <p class="mt-4 text-lg text-gray-600">
        Discover a curated selection of products from around the globe, designed to enhance your lifestyle and meet your everyday needs.
      </p>
    </div>
  </section>
  <div class="bg-white">
